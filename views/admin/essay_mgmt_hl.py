...
#
#
# @router.message(F.text=="Essay MGMT", RoleFilter([0]))
# async def essay_mgmt_f(mess: types.Message, u=None):
...
#
#     await mess.answer(
#         text="Congrats 🎉. You have created new essay\n\n"
#              f"Name: {name}\n"
#              f"Cost: {cost}\n"
...
#     )
#     await state.clear()
#     await essay_mgmt_f(mess=mess, u=mess.from_user)
